...
@section('content')
    ...
    <div id="TopNav" class="relative flex items-center justify-between px-5 mt-[60px]">
        <a href="find-kos.html" class="w-12 h-12 flex items-center justify-center shrink-0 rounded-full overflow-hidden bg-white">
        ...
        <a href="details.html" class="card">
            <div class="flex rounded-[30px] border border-[#F1F2F6] p-4 gap-4 bg-white hover:border-[#91BF77] transition-all duration-300">
                ...
                <div class="flex flex-col gap-3 w-full">
                    <h3 class="font-semibold text-lg leading-[27px] line-clamp-2 min-h-[54px]">Tumbuh Tentram Berada Rumah Nenek</h3>
                    ...
                    <hr class="border-[#F1F2F6]">
                    <p class="font-semibold text-lg text-ngekos-orange">Rp 4.593.444<span class="text-sm text-ngekos-grey font-normal">/bulan</span></p>
                </div>
            </div>
        </a>
        <a href="details.html" class="card">
